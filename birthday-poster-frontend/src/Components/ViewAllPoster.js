  ...
  const closeModal = () => {
   ...
   const shareOnWhatsApp = async () => {
    ...
    try {
      ...
      const res = await axiosData.post("upload/share", shareData, {
        headers: {
      ...
      >
        <motion.div initial={{ x: -20 }} animate={{ x: 0 }}>
          <Typography
            ...
            sx={{
              fontWeight: 800,
              background: "linear-gradient(45deg, #ff3d3d 0%, #a91111ff 100%)",
                  ...
                  >
                    ...
                    <Chip
                      ...
                      sx={{
                        ...
                        fontWeight: 600,
                        border: `1px solid ${getTypeDetails(media.type).color}`,
                      }}
                      color="#fff"
                    />
                  </Box>
                      ...
                      <Stack direction="row" spacing={2}>
                        ...
                        <Button
                          ...
                          sx={{
                            ...
                            } 0%, ${getTypeDetails(media.type).color}80 100%)`,
                            boxShadow: `0 2px 8px ${
                              getTypeDetails(media.type).color
                            }40`,
                            "&:hover": {
                        ...
                        {(media.whatsappstatus === "pending" || media.whatsappstatus === "no") &&<div style={{ margin: "10px" }}>
                              <IconButton
                                onClick={()=>{
                                  setMedia(media)
                                  openModal()}}
